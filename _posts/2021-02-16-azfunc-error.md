...
I've been building a queue reader with [Azure Functions](https://docs.microsoft.com/en-us/azure/azure-functions/functions-overview) recently and ran into an exception that took me a while to fix. Hopefully this will help others short-circuit the process :smile:
...
3. In a [PowerShell](https://docs.microsoft.com/en-us/powershell/scripting/overview?view=powershell-7.1) terminal I was start my function.
